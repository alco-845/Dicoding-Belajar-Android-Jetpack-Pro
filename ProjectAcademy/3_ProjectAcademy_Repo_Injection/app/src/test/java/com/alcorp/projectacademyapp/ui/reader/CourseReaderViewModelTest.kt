...
class CourseReaderViewModelTest {
    ...
    @Test
    fun getModules(){
        `when`<ArrayList<ModuleEntity>>(academyRepository.getAllModulesByCourse(courseId) as ArrayList<ModuleEntity>?).thenReturn(dummyModules as ArrayList<ModuleEntity>?)
