    ...
    private fun populateFragment() {
        ...
        if (!isLarge) {
            ...
            if (fragmentList == null){
                ...
                fragmentTransaction.add(R.id.frame_container, fragmentList, ModuleListFragment.TAG)
            }
            ...
            if (fragmentContent == null){
                ...
                fragmentTransaction.add(R.id.frame_container, fragmentContent, ModuleContentFragment.TAG)
            }
            fragmentTransaction.commit()
        }
    }
