package com.alcorp.projectacademyapp.utils
    ...
    fun loadCourses(): List<CourseResponse> {
        ...
        try {
            ...
            for (i in 0 until listArray.length()) {
                ...
                val descrition = course.getString("description")
                val date = course.getString("date")
                val imagePath = course.getString("imagePath")

                val courseResponse = CourseResponse(id, title, descrition, date, imagePath)
