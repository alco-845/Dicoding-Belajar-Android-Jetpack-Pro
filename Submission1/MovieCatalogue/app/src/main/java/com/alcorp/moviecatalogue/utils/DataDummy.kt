...
object DataDummy {
    ...
    fun generateDummyMovie(): List<MovieEntity> {
        ...
        movies.add(MovieEntity(
            ...
            "Business competition in New York at that time involved five major families, namely Corleone, Barzini, Tataglia, Cuneo and Stracci. Competition and dirty games are halal. Don Vito was nearly killed in the fruit tax. Michael doesn't want to stay silent and is determined to take revenge.",
            "1972",
            R.drawable.movie1
        ))
    ...
    fun generateDummyTvShow(): List<TvShowEntity> {
        ...
        tvShow.add(TvShowEntity(
                "tv10",
                "The Simpsons",
                "The Simpsons focuses on the daily life of the Simpsons family consisting of Homer, Marge, Bart, Lisa and Maggie living in a town called Springfield.",
                "1989-2007",
